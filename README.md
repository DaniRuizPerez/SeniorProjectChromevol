...
This was part of the senior project of my undergrad in computer science at UDC (Spain), carried out in collaboration with the group CHROMEVOL from Florida International University and RNASA from University of La Coruña. My thesis directores were Daniel Rivero Cebrián and Vanessa Aguiar-Pulido (@github.com/vaguiarpulido). The 165 pages report (Spanish) can be viewed [here](https://github.com/DaniRuizPerez/SeniorProjectChromevol/blob/master/Report.pdf) for further explanations. All the use-cases, architecture, design, testing, UML and other diagrams can be seen there.
